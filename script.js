...
var vacancyData = ["Database Developer", "System Analyst", "Front End Developer"];

// Data untuk dropdown Posisi
var posisiData = ["Jakarta", "Bandung"];

// Ambil elemen dropdown Lowongan dan Posisi
var vacancyDropdown = document.getElementById("vacancy");
...
vacancyData.forEach(function (vacancy) {
    ...
    option.text = vacancy;
    vacancyDropdown.appendChild(option);
});
